		...
		<div class="max-w-screen-xl px-8 mx-auto flex flex-col lg:flex-row items-start">
			...
			<div class="w-full lg:w-6/12 lg:-mt-10 relative" id="girl">
				...
				<div data-aos="fade-up" data-aos-delay="400" data-aos-once="true" class="absolute top-20 right-10 sm:right-24 sm:top-28 md:top-36 md:right-32 lg:top-32 lg:right-16 floating">
					...
					<img class="bg-opacity-80 rounded-lg h-14 sm:h-18" src="{{ asset('images/polri-briptu.png') }}" alt="">
				</div>
				<!-- ux class -->
				<div data-aos="fade-up" data-aos-delay="500" data-aos-once="true" class="absolute bottom-14 -left-4 sm:left-2 sm:bottom-20 lg:bottom-24 lg:-left-4 floating">
					<img class="bg-opacity-80 rounded-lg h-20 sm:h-28" src="{{ asset('images/tni-baret-hijau.png') }}" alt="">
				</div>
				<!-- congrats -->
				<div data-aos="fade-up" data-aos-delay="600" data-aos-once="true" class="absolute bottom-20 md:bottom-48 lg:bottom-52 -right-6 lg:right-8 floating-4">
					<img class="bg-opacity-80 rounded-lg h-40 sm:h-40" src="{{ asset('images/topi-pdh-polri.png') }}" alt="">
				</div>
			</div>
		</div>
	...
	<div class="container px-4 lg:px-8 mx-auto max-w-screen-xl text-gray-700 overflow-x-hidden" id="whoami">
		...
		<div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
			<div data-aos="fade-up" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Kurikulum Adaptif & Latihan Intensif</h1>
				<p class="px-4 text-gray-500">Materi pelajaran dan modul latihan disusun berdasarkan standar seleksi terbaru TNI & Polri. Latihan soal tak terbatas untuk mengasah kemampuanmu di setiap tahapan.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="150" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<h1 class="font-medium text-xl mb-3 lg:px-14 text-darken">Simulasi Ujian & Penilaian Akurat</h1>
				<p class="px-4 text-gray-500">Ikuti simulasi ujian berbasis komputer (CAT) dan tes fisik yang menyerupai kondisi sebenarnya. Dapatkan analisis hasil yang mendalam untuk mengidentifikasi kekuatan dan area yang perlu ditingkatkan.</p>
			</div>
			<div data-aos="fade-up" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
				...
				<h1 class="font-medium text-xl mb-3 lg:px-14 text-darken lg:h-14 pt-3">Pemantauan Progres Pribadi & Konsultasi</h1>
				<p class="px-4 text-gray-500">Lacak progres belajarmu secara detail. Tim pengajar dan konselor kami siap memberikan feedback personal dan strategi belajar yang efektif.</p>
			</div>
		</div>
		...
		<div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
			...
			<img data-aos="fade-left" class="md:w-1/2" src="{{ asset('images/girl-with-books.png') }}">
		</div>
        -->
		...
		<div class="mt-20 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			<div data-aos="fade-right" class="md:w-6/12">
				<img class="md:w-11/12" src="{{ asset('images/true-false.png') }}">
			</div>
			<div data-aos="fade-left" class="md:w-6/12 md:transform md:-translate-y-20">
				<h1 class="font-semibold text-darken text-3xl lg:pr-64">Evaluasi Berbasis Data: <span class="text-blue-custom">Asesment</span>, Kuis, & Tes</h1>
				<p class="text-gray-500 my-5 lg:pr-52">Dapat dengan mudah mengakses berbagai tugas, kuis, dan tes yang relevan dengan seleksi TNI/Polri. Hasil akan secara otomatis dicatat dalam online gradebook untuk analisis yang akurat dan feedback yang cepat.</p>
			</div>
		</div>
		...
		<div class="flex flex-col md:flex-row items-center mt-12">
			<div data-aos="fade-right" class="md:w-5/12">
				<h1 class="text-darken font-semibold text-3xl leading-tight lg:pr-32"><span class="text-blue-custom">Class Management</span> Tools for Educators</h1>
			...
			<img data-aos="fade-left" class="md:w-7/12" src="{{ asset('images/gradebook.png') }}">
		</div>
		...
		<div class="mt-24 flex flex-col-reverse md:flex-row items-center md:space-x-10">
			...
			<div data-aos="fade-left" class="md:w-5/12 md:transform md:-translate-y-6">
				...
				<p class="text-gray-500 my-5 lg:pr-24">Pengajar dan konselor kami dapat melakukan diskusi atau bimbingan privat dengan siswa secara langsung.</p>
			</div>
		</div>
